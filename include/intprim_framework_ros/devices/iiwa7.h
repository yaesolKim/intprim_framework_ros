...
class IIWA7State : public DeviceState
{
    public:
        static constexpr unsigned int           NUM_JOINTS = 7;
        static std::string                      JOINT_NAMES[NUM_JOINTS]; //added
...
class IIWA7Interface : public RobotInterface
{
    public:
      IIWA7Interface(ros::NodeHandle handle);//, std::string robot_type);

        // Covariant return type.
        const IIWA7State& get_state();
